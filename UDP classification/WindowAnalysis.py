...
def classifiers(data, seconds, save_dir):
    ...
    dataset_path = "/home/det_tesi/sgarofalo/Window size analysis/train_dataset/dataset.csv"
    ...
    # Test Set
    # #############################################################################
    dataset = pd.read_csv("/home/det_tesi/sgarofalo/Window size analysis/test_dataset/dataset.csv")
    X = dataset.iloc[:, :-1]
    y = dataset.iloc[:, -1:]
    y[y.label == 'RTP'] = 1
    y[y.label == 'Not RTP'] = 0
...
test_dir = "/home/det_tesi/sgarofalo/Window size analysis/test_dataset"
