...
if __name__ == "__main__":
    ...
    parser.add_argument ("-q", "--quality", help = "HQ if HQ video 720p, LQ low 180p, MQ medium 360p", choices=['LQ', 'MQ', 'HQ'],\
                        default = None)
    ...
    pool= multiprocessing.Pool(processes = n_process) #Limito il numero di processi ai core della cpu -1
    pool_tuple = [(x, port_used, args.screen, args.quality) for x in list_app_name]  #result_list, args.plot
